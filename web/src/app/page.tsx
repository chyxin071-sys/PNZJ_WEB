...
import { ChevronRight, TrendingUp, Hammer, DollarSign, Users, FileText, Activity, Settings, X, Target, PieChart as PieChartIcon, ChevronDown, Check } from "lucide-react";
                        ...
                        label={({ name, percent, cx, cy, midAngle, outerRadius, innerRadius }) => {
                          ...
                          return (
                            <text x={x} y={y} fill="#6b7280" textAnchor={textAnchor} dominantBaseline="central" style={{ fontSize: '10px', fontWeight: 'normal' }}>
                              ...
                              <tspan x={x} dy="1.2em">{`${((percent || 0) * 100).toFixed(0)}%`}</tspan>
                            </text>
                          );
                        }}
                      >
