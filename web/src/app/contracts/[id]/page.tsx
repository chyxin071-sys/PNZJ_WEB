      ...
      <div className="p-8 max-w-[1200px] mx-auto space-y-8 pb-32">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 relative">
          <div>
            ...
            <p className="text-primary-600 mt-2 font-mono text-sm">关联客户：{customer.name} <span className="text-primary-400">NO.</span>{customer.customerNo || customer._id || customer.id}</p>
          </div>
